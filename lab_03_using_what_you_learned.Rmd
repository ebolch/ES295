...
><span style="color:CRIMSON;">13. Use ggplot to make a publication quality figure that has all 5 vegetation spectra on a single plot. Color each spectrum separately and include a legend. Save your plot as a png and upload it to catcourses. If you are unsure of the requirements for a publication quality figure, review the requirements for publishing in Remote Sensing of the Environment. </span>
